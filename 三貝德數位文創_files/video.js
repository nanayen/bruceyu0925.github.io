...
var MouseTimeDisplay = function (_Component) {
  ...
  MouseTimeDisplay.prototype.createEl = function createEl() {
    return _Component.prototype.createEl.call(this, 'div', {
	  ...
	  innerHTML: '<img id="videoPreviewThumb" class="videoPreviewThumb" />'
    });
  };
  ...
  MouseTimeDisplay.prototype.update = function update(seekBarRect, seekBarPoint) {
    ...
    this.rafId_ = this.requestAnimationFrame(function () {
      ...
      var current_second = seekBarPoint * duration;
	  ...
	  /*
	  try {
		  if (thumbCurrentSecond != parseInt(current_second, 10)) {
			  thumbCurrentSecond = parseInt(current_second, 10);
			  // console.log(thumbCurrentSecond);
			  var tmpVideoUrl = new URL(video.currentSrc);
			  getVideoThumb(parseInt(tmpVideoUrl.searchParams.get("vd_id"), 10), thumbCurrentSecond);
		  }
	  }
	  catch {}
	  */
...
var SeekBar = function (_Slider) {
  ...
  SeekBar.prototype.handleMouseDown = function handleMouseDown(event) {
    ...
    _Slider.prototype.handleMouseDown.call(this, event);
		...
		if(this.videoWasPlaying){
			if(document.querySelectorAll("div.all_contents_block div.comment_block").length == 1){
				document.querySelectorAll("div.all_contents_block div.comment_block")[0].classList.add("-from-seekbar");
			}
		}else{
		}
  };
  ...
  SeekBar.prototype.handleMouseMove = function handleMouseMove(event) {
    ...
    this.player_.currentTime(newTime);
		...
		if(this.videoWasPlaying){
			if(document.querySelectorAll("div.all_contents_block div.comment_block").length == 1){
				document.querySelectorAll("div.all_contents_block div.comment_block")[0].classList.add("-none");
			}
		}else{
			if(this.videoWasPlaying != undefined){
				if(document.querySelectorAll("div.all_contents_block div.comment_block").length == 1){
					document.querySelectorAll("div.all_contents_block div.comment_block")[0].classList.remove("-none");
				}
			}
		}
...
var ProgressControl = function (_Component) {
  ...
  ProgressControl.prototype.createEl = function createEl$$1() {
    return _Component.prototype.createEl.call(this, 'div', {
      className: 'vjs-progress-control vjs-control custom-vjs'
    });
  };
